...
export default function CompletionScreen({ onBack }: { onBack: () => void }) {
...
const styles = StyleSheet.create({
  ...
  bottomBar: { paddingHorizontal: 24, paddingVertical: 20, borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,0.06)' },
  verifyBtn: { backgroundColor: '#FF7800', borderRadius: 16, paddingVertical: 18, alignItems: 'center' },
