      ...
      <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
        <View style={styles.content}>
          ...
          {[
            ...
            { title: '3. Blockchain Interactions', text: 'Our apps interact with Solana mainnet. Transactions are public by nature. When you complete a quest or earn a badge, a transaction is recorded on-chain. This is how the Solana network works.\n\nAll signing happens through Seed Vault — Solana Mobile\'s secure hardware enclave. We never see your private keys.' },
            { title: '4. Wallet Permissions', text: 'We only request:\n\n• Sign transactions — to verify quest completion on-chain\n• Public wallet address — to associate badges with your wallet' },
