      ...
      <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
        <View style={styles.content}>
          ...
          {[
            ...
            { title: '6. Acceptable Use', text: 'Do not attempt to manipulate quest verification, use bots, reverse engineer the apps, or use them for illegal purposes.' },
